...
class ExelGen extends Controller
{
    ...
    public function generateExcel(Request $request)
    {
        ...
        foreach ($this->wordBreak($date['projectName'] . ' ' . $date['projectAddres'], 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
        ...
        foreach ($this->wordBreak($builderName . ', ОРГН ' . $builderORGN . ' ИНН ' . $builderINN . ' ' . $builderAddres . ' тел. ' . $builderPhone . ' факс. ' . $builderFax, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak('ОРГН ' . $builderOrgORG . ' ИНН ' . $builderOrgINN, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($contractorOrgName . ' ОРГН ' . $contractorOrgORGN . ' ИНН ' . $contractorOrgINN, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak('Лицо, осуществляющее подготовку проектной документации', 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleTitle]
        ...
        foreach ($this->wordBreak($preparationName . ' ОРГН ' . $preparationORGN . ' ИНН ' . $preparationINN . ' ' . $preparationAddres . ' тел. ' . $preparationPhone . ' факс ' . $preparationFax, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($preparationOrgName . ' ОРГН ' . $preparationOrgORGN . ' ИНН ' . $preparationOrgINN, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak('ОРГН ' . $representativeBuilderORGN . ' ИНН ' . $representativeBuilderINN . ' ' . $representativeBuilderAddres, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($representativeContractorPosition . ' ' . $representativeContractorFIO . ' №' . $representativeContractorRequisites . ' от ' . $representativeContractorDate, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($memberBuilderPosition . ' ' .  $memberBuilderFIO . ' идентификационный № ' . $memberBuilderId . ' № ' . $memberBuilderRequisites . ' от ' . $memberBuilderDate, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        $preparationORGN = $date['preparationORGN'];
        $preparationINN = $date['preparationINN'];
        foreach ($this->wordBreak($preparationPosition . ' ' . $preparationFIO . ' №' . $preparationREQ . ' от ' . $preparationDateId . ', ' . $preparationYurName . ' ОРГН ' . $preparationORGN . ' ИНН ' . $preparationINN . ' ' . $preparationYurAddres, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($complitePosition . ' ' . $compliteFIO . ' № ' . $compliteREQ . ' от ' . $compliteDateId . ' ' . $compliteNameYUR . ' ОРГН ' . $compliteORGN . ' ИНН ' . $compliteINN . ' ' . $compliteYURaddres, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach($anotherPosition as $key => $anotherPositionValue){
            foreach ($this->wordBreak($anotherPositionValue . ' ' . $anotherNameYur[$key] . ' ' . $anotherFIO[$key] . '  распоряжение №' . $anotherREQ[$key] . ' от ' . $anotherDate_Id[$key], 160) as $text) {
                $this->i++;
                $this->creatRow(
                    [
                        ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($checkName, 160) as $text) {
        ...
        foreach($date['workDo'] as $key => $value){
            foreach ($this->wordBreak($value, 160) as $text) {
                $this->i++;
                $this->creatRow(
                    [
                        ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($anotherDocs, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($materialName . ' ' . $sertificate . ' действителен с ' . $sertificatefrom  . ' по ' . $sertificateBy . ', '.$sertificateQuality.' от '.$sertificateDate, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach($doc as $key => $value){
            foreach ($this->wordBreak('Согласно реестру № ' . $value . ' от ' . $docDate[$key], 160) as $text) {
                $this->i++;
                $this->creatRow(
                    [
                        ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($this->formatDate($dateBeginWork), 160) as $text) {
        ...
        foreach ($this->wordBreak($this->formatDate($dateEndWork), 160) as $text) {
            $this->creatRow(
                [
                    ['row' => 'E' . $this->i . ':G' . $this->i  . '', 'text' => $text, 'style' => $styleText]
                ]
        ...
        foreach ($this->wordBreak($razdeDoc . ' ' . $RegName, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($nameWorkCostruct, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak('Дополнительные сведения', 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':D' . $this->i . '', 'text' => $text, 'style' => $styleTitle]
        ...
        foreach ($this->wordBreak($moreInfo, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($countAOSR, 160) as $text) {
        ...
        foreach ($this->wordBreak($representativeBuilderFIO, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($representativeContractorFIO, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($memberBuilderFIO, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($preparationFIO, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($compliteFIO, 160) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        // foreach ($this->wordBreak($anotherFIO, 160) as $text) {
        //     $this->i++;
        //     $this->creatRow(
        //         [
        //             ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
