...
class ExelGen extends Controller
{
    ...
    public function generateExcel(Request $request)
    {
        ...
        foreach ($this->wordBreak($date['projectName'] . ' ' . $date['projectAddres'], 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
        ...
        foreach ($this->wordBreak('ОРГН ' . $builderOrgORG . ' ИНН ' . $builderOrgINN, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($contractorOrgName . ' ОРГН ' . $contractorOrgORGN . ' ИНН ' . $contractorOrgINN, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak('Лицо, осуществляющее подготовку проектной документации', 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleTitle]
        ...
        foreach ($this->wordBreak($preparationName . ' ОРГН ' . $preparationORGN . ' ИНН ' . $preparationINN . ' ' . $preparationAddres . ' тел. ' . $preparationPhone . ' факс ' . $preparationFax, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($preparationOrgName . ' ОРГН ' . $preparationOrgORGN . ' ИНН ' . $preparationOrgINN, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak('ОРГН ' . $representativeBuilderORGN . ' ИНН ' . $representativeBuilderINN . ' ' . $representativeBuilderAddres, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($representativeContractorPosition . ' ' . $representativeContractorFIO . ' №' . $representativeContractorRequisites . ' от ' . $representativeContractorDate, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($memberBuilderPosition . ' ' .  $memberBuilderFIO . ' идентификационный № ' . $memberBuilderId . ' № ' . $memberBuilderRequisites . ' от ' . $memberBuilderDate, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        $preparationORGN = $date['preparationORGN'];
        $preparationINN = $date['preparationINN'];
        foreach ($this->wordBreak($preparationPosition . ' ' . $preparationFIO . ' №' . $preparationREQ . ' от ' . $preparationDateId . ', ' . $preparationYurName . ' ОРГН ' . $preparationORGN . ' ИНН ' . $preparationINN . ' ' . $preparationYurAddres, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($complitePosition . ' ' . $compliteFIO . ' № ' . $compliteREQ . ' от ' . $compliteDateId . ' ' . $compliteNameYUR . ' ОРГН ' . $compliteORGN . ' ИНН ' . $compliteINN . ' ' . $compliteYURaddres, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach($anotherPosition as $key => $anotherPositionValue){
            foreach ($this->wordBreak($anotherPositionValue . ' ' . $anotherNameYur[$key] . ' ' . $anotherFIO[$key] . '  распоряжение №' . $anotherREQ[$key] . ' от ' . $anotherDate_Id[$key], 170) as $text) {
                $this->i++;
                $this->creatRow(
                    [
                        ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($checkName, 170) as $text) {
        ...
        foreach($date['workDo'] as $key => $value){
            foreach ($this->wordBreak($value, 170) as $text) {
                $this->i++;
                $this->creatRow(
                    [
                        ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($anotherDocs, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($materialName . ' ' . $sertificate . ' действителен с ' . $sertificatefrom  . ' по ' . $sertificateBy . ', '.$sertificateQuality.' от '.$sertificateDate, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach($doc as $key => $value){
            foreach ($this->wordBreak('Согласно реестру № ' . $value . ' от ' . $docDate[$key], 170) as $text) {
                $this->i++;
                $this->creatRow(
                    [
                        ['row' => 'A' . $this->i . ':I' . $this->i . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($this->formatDate($dateBeginWork), 170) as $text) {
        ...
        foreach ($this->wordBreak($this->formatDate($dateEndWork), 170) as $text) {
            $this->creatRow(
                [
                    ['row' => 'E' . $this->i . ':G' . $this->i  . '', 'text' => $text, 'style' => $styleText]
                ]
        ...
        foreach ($this->wordBreak($razdeDoc . ' ' . $RegName, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($nameWorkCostruct, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak('Дополнительные сведения', 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i . ':D' . $this->i . '', 'text' => $text, 'style' => $styleTitle]
        ...
        foreach ($this->wordBreak($moreInfo, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($countAOSR, 170) as $text) {
        ...
        foreach ($this->wordBreak($representativeBuilderFIO, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($representativeContractorFIO, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($memberBuilderFIO, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($preparationFIO, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        foreach ($this->wordBreak($compliteFIO, 170) as $text) {
            $this->i++;
            $this->creatRow(
                [
                    ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
        ...
        // foreach ($this->wordBreak($anotherFIO, 170) as $text) {
        //     $this->i++;
        //     $this->creatRow(
        //         [
        //             ['row' => 'A' . $this->i  . ':I' . $this->i  . '', 'text' => $text, 'style' => $styleText]
