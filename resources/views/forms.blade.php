    ...
    <div class="form-card">
      ...
      <div class="header-forms">
        <div class="row">
          ...
          <div class="col-lg-2">
            <div class="step">Шаг <div class="step-count"></div> из <div class="step-all"></div></div>
          </div>
        </div>
      </div>
      <!-- input step --> 
          ...
          <div class="content_section">
            ...
            <div class="row_element document_in ">
              ...
              <div class="row add_document_block">
                <div class="col-lg-6"><div class="add_doc"><div class="add"></div> Добавить сертификат </div></div>
                <div class="col-lg-6"><div class="add_doc_2"><div class="add"></div> Документ подтверждающий качество </div></div>
              </div>
            </div>
          </div>
