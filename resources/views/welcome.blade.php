  ...
  <div class="home_banner">
    <div class="container">
      <div class="banner">
        ...
        <span>Строительство в России неизбежно сильно бюрократизировано.  Каждый этап работ, начиная от разработки котлована до отделочных работ, оформляется документально. В каждом документе собираются много подписей, от 5 человек минимум.  А при составлении документов вручную часто совершаются много ошибок и опечаток. 
          <br>
          <br>
          Что-бы избежать таких ошибок в документах мы хотим создать такой сервис, который исключит это. Этот сервис сможет помочь облегчить бумажную работу инженерам ПТО и прорабами. Но он пока ещё сырой. 
          <br>
          <br>
          Сейчас можно оформить только АОСР. В будущем добавим ОЖР, АООК, специальные журналы и КС-2. Будем рады обратной связи и конструктивной критике.</span>
          <br>
          <br>
