                    ...
                    <form action="/personal/list/ojr/add/newojr" method="get" class="form-ojr">
                        ...
                        <div class="form-group" style="margin-left: -15px;">
                            ...
                            <div class="col-sm-8 col-lg-7">
                                <input  name="nameOjr" type="text" required class="form-control" id="nameOjr" placeholder="">
                            </div>
                        ...
                        <div class="form-group" style="margin-left: -15px;">
                            ...
                            <div class="col-sm-8 col-lg-7">
                                <input  name="date_start_ojr" type="date" required class="form-control" id="nameOjr" placeholder="">
                            </div>
                        ...
                        <div class="form-group" style="margin-left: -15px;">
                            ...
                            <div class="col-sm-8 col-lg-7">
                                <input  name="date_end_ojr" type="date" required class="form-control" id="nameOjr" placeholder="">
                            </div>
